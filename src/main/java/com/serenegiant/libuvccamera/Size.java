...
public class Size implements Parcelable {
    ...
    /**
     * The uvc_raw_format_t value on the native side is mainly used for libuvc
     * 9999 is still image
     */
    public int type;
    /**
     * raw_frame_t value on the native side, for androusb, libuvc is not supported
     */
    ...
    // The following is calculated based on frameIntervalType and interval with #updateFrameRate
    public float[] fps;
     ...
     * Construction method
     *
     * @param _type       native_raw_format_t value, where 9999 is a still image
     * @param _frame_type native side raw_frame_t value
     * @param _index
     * @param _width
     * @param _height
     */
    ...
    private Size(final Parcel source) {
        // The reading order must be the same as the writing order in writeToParcel.
        type = source.readInt();
    ...
    public void updateFrameRate() {
        ...
        if (n > 0) {
            ...
            try {
                ...
                // ignore, I want to know if the minimum and maximum are 0
                fps = null;
            }
        }
