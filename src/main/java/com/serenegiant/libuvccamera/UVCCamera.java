...
import com.serenegiant.libuvccamera.LibUVCCameraUSBMonitor.UsbControlBlock;
...
public class UVCCamera {
    ...
    protected long mControlSupports;            // Function flags supported by camera controls
    protected long mProcSupports;                // Feature flags supported by the processing unit
    ...
    // The angle of the camera itself, the image obtained from the camera will be rotated according to this angle
    ...
    private static native int nativeSetPreviewSize(final long id_camera, final int width, final int height, final int cameraAngle, final int min_fps, final int max_fps, final int mode);
...
//    		mNativePtr = 0;	// nativeDestroy is called, so don't clear here
        }
        if (mCtrlBlock != null) {
            mCtrlBlock.close();
            mCtrlBlock = null;
     ...
     * @return
     */
    public int setPreviewSize(final int width, final int height) {
        return setPreviewSize(width, height, DEFAULT_CAMERA_ANGLE, DEFAULT_PREVIEW_MIN_FPS, DEFAULT_PREVIEW_MAX_FPS, mCurrentFrameFormat);
    }
     ...
     * @return
     */
    public int setPreviewSize(final int width, final int height, final int frameFormat) {
        return setPreviewSize(width, height, DEFAULT_CAMERA_ANGLE, DEFAULT_PREVIEW_MIN_FPS, DEFAULT_PREVIEW_MAX_FPS, frameFormat);
    }
     ...
     * @return
     */
    public int setPreviewSize(final int width, final int height, final int cameraAngle, final int frameFormat) {
        return setPreviewSize(width, height, cameraAngle, DEFAULT_PREVIEW_MIN_FPS, DEFAULT_PREVIEW_MAX_FPS, frameFormat);
    }
     ...
     * @return
     */
    public int setPreviewSize(final int width, final int height, final int cameraAngle, final int min_fps, final int max_fps, final int frameFormat) {
    ...
    public List<Size> getSupportedSizeList() {
        return getSupportedSizeList(mCurrentFrameFormat);
    }
    ...
    public synchronized void startPreview() {
        ...
        Log.e(TAG, "startPreview error. mCtrlBlock=" + mCtrlBlock);
    }
