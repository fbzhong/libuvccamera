...
public interface IFrameCallback {
     ...
     *              If you need to process the frame data, it is recommended to copy a copy for processing.
     *              It is recommended to use thread asynchronous processing, otherwise the uvc will be blocked.
     */
