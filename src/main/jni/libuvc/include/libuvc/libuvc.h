...
enum uvc_frame_format {
  ...
  UVC_FRAME_FORMAT_RGBA,		// RGBA8888
...
uvc_error_t uvc_mjpeg2rgba(uvc_frame_t *in, uvc_frame_t *out);		// XXX
#ifdef LIBUVC_USE_TURBOJPEG
int uvc_turbojpeg_init(); // XXX added
void uvc_turbojpeg_destroy(); // XXX added
#endif
#endif
